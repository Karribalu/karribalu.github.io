        ...
        <div className='footer_right'>
            <form onSubmit={handleSubmit} className='form'>
                ...
                <div className='form-name'>
                    ...
                    <input type="text" name="name" id="name" placeholder="Name" className='input-name' required/>
                    <ValidationError 
                    prefix="Name" 
                    field="name"
                    errors={state.errors}
                ...
                <div className='form-email'>
                    ...
                    <input type="email" name="email" id="email" placeholder="Email" className='input-email' required/>
                    <ValidationError 
                    prefix="Email" 
                    field="email"
                    errors={state.errors}
                ...
                <div className='form-message'>
                    ...
                    <textarea name="message" id="message" cols="30" rows="10" placeholder="Message" className='input-message' required></textarea>
                            <ValidationError 
                    prefix="Message" 
                    field="message"
                    errors={state.errors}
